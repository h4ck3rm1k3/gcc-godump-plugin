...
typedef struct constructor_elt constructor_elt_t;
...
PARM_DECL,
TYPE_DECL,
RESULT_DECL,DEBUG_EXPR_DECL,NAMESPACE_DECL,IMPORTED_DECL,NAMELIST_DECL,TRANSLATION_UNIT_DECL,COMPONENT_REF,BIT_FIELD_REF,
ARRAY_REF,
ARRAY_RANGE_REF,REALPART_EXPR,
IMAGPART_EXPR,VIEW_CONVERT_EXPR,
INDIRECT_REF,
OBJ_TYPE_REF,
CONSTRUCTOR,
COMPOUND_EXPR,
MODIFY_EXPR,
INIT_EXPR,TARGET_EXPR,COND_EXPR,VEC_COND_EXPR,VEC_PERM_EXPR,BIND_EXPR,CALL_EXPR,
WITH_CLEANUP_EXPR,CLEANUP_POINT_EXPR,PLACEHOLDER_EXPR,
PLUS_EXPR,
MINUS_EXPR,
...
LOOP_EXPR,SWITCH_EXPR,CASE_LABEL_EXPR,
ASM_EXPR,
SSA_NAME,CATCH_EXPR,
EH_FILTER_EXPR,SCEV_KNOWN,SCEV_NOT_KNOWN,POLYNOMIAL_CHREC,STATEMENT_LIST,ASSERT_EXPR,TREE_BINFO,
WITH_SIZE_EXPR,REALIGN_LOAD_EXPR,TARGET_MEM_REF,MEM_REF,OMP_PARALLEL,OMP_TASK,OMP_FOR,OMP_SIMD,CILK_SIMD,OMP_DISTRIBUTE,
OMP_TEAMS,
OMP_TARGET_DATA,
OMP_TARGET,
OMP_SECTIONS,
OMP_SINGLE,OMP_SECTION,OMP_MASTER,OMP_TASKGROUP,OMP_ORDERED,
OMP_CRITICAL,OMP_TARGET_UPDATE,OMP_ATOMIC,
OMP_ATOMIC_READ,OMP_ATOMIC_CAPTURE_OLD,
OMP_ATOMIC_CAPTURE_NEW,
OMP_CLAUSE,TRANSACTION_EXPR,REDUC_MAX_EXPR,
REDUC_MIN_EXPR,
REDUC_PLUS_EXPR,DOT_PROD_EXPR,WIDEN_SUM_EXPR,
WIDEN_MULT_EXPR,WIDEN_MULT_PLUS_EXPR,
WIDEN_MULT_MINUS_EXPR,WIDEN_LSHIFT_EXPR,FMA_EXPR,
VEC_LSHIFT_EXPR,
VEC_RSHIFT_EXPR,
...
ATTR_ADDR_EXPR,STMT_STMT,LOOP_STMT,EXIT_STMT,OFFSET_REF,
PTRMEM_CST,NEW_EXPR,
VEC_NEW_EXPR,
DELETE_EXPR,
VEC_DELETE_EXPR,
...
AGGR_INIT_EXPR,
VEC_INIT_EXPR,THROW_EXPR,EMPTY_CLASS_EXPR,BASELINK,TEMPLATE_DECL,TEMPLATE_PARM_INDEX,TEMPLATE_TEMPLATE_PARM,
TEMPLATE_TYPE_PARM,
TYPENAME_TYPE,
TYPEOF_TYPE,
...
DEFAULT_ARG,
DEFERRED_NOEXCEPT,
TEMPLATE_ID_EXPR,OVERLOAD,PSEUDO_DTOR_EXPR,MODOP_EXPR,
CAST_EXPR,
...
DOTSTAR_EXPR,
TYPEID_EXPR,
NOEXCEPT_EXPR,NON_DEPENDENT_EXPR,CTOR_INITIALIZER,TRY_BLOCK,EH_SPEC_BLOCK,HANDLER,
MUST_NOT_THROW_EXPR,
...
STMT_EXPR,UNARY_PLUS_EXPR,STATIC_ASSERT,TYPE_ARGUMENT_PACK,NONTYPE_ARGUMENT_PACK,TYPE_PACK_EXPANSION,
EXPR_PACK_EXPANSION,ARGUMENT_PACK_SELECT,
TRAIT_EXPR,LAMBDA_EXPR,
...
typedef struct constructor_vector {
  constructor_elt item;
} constructor_vector_t;
...
typedef union omp_clause_subcode {
